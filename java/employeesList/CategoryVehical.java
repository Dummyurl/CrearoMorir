...
import com.bluehorntech.generalservicesapplication.ListViewAdapterAllEpmz;
...
public class CategoryVehical extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(list.equalsIgnoreCase("true")){
            ...
            Toast.makeText(CategoryVehical.this, "No se encontraron profesionales", Toast.LENGTH_SHORT).show();
        }
