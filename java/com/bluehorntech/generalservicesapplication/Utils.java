...
public class Utils {
	...
	public static final String REGISTER_URL = "http://oficiosya.esy.es/api.php";
	public static final String CATEGORY_URL = "http://oficiosya.esy.es/api.php?category=category";
